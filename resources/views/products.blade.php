        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody>
                    ...
                    <template x-if="!loading && products.length === 0">
                        <tr>
                            <td colspan="8" class="px-4 py-16 text-center text-gray-400">Tidak ada produk ditemukan</td>
                        </tr>
                    </template>
                    <template x-for="(p, i) in products" :key="p.kledoId">
                        <tr class="border-b border-gray-50 hover:bg-blue-50/30 transition">
                            ...
                            <td class="px-4 py-3 text-right">
                                <span :class="p.kledoStok > 0 ? 'text-blue-700 font-semibold' : 'text-red-400 font-medium'" x-text="p.kledoStok.toLocaleString('id-ID')"></span>
                            </td>
                        </tr>
                    </template>
                </tbody>
