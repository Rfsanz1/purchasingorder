  ...
  return (
    <AppShell {...ACCOUNTING_CONFIG} navItems={ACCOUNTING_NAV} activeHref="/finance/reports">
      <div className="p-6 space-y-6 max-w-5xl mx-auto">
        <div><h1 className="text-xl font-bold" style={{ color: '#433C50' }}>Laporan Keuangan</h1><p className="text-sm mt-0.5" style={{ color: '#A5A3AE' }}>Ringkasan laba-rugi dan arus kas</p></div>
