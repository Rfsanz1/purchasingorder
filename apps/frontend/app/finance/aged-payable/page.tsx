    ...
    <AppShell {...ACCOUNTING_CONFIG} navItems={ACCOUNTING_NAV} activeHref="/finance/aged-payable">
      <div className="p-6 space-y-6 max-w-6xl mx-auto">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl font-bold" style={{ color: '#433C50' }}>Aging Hutang (Aged Payable)</h1>
            <p className="text-sm mt-0.5" style={{ color: '#A5A3AE' }}>Analisa umur hutang supplier berdasarkan tanggal jatuh tempo</p>
          </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr style={{ borderBottom: '1px solid #EDE8F5', backgroundColor: '#F8F7FC' }}>
                  <th className="px-6 py-3 text-left text-xs font-semibold" style={{ color: '#A5A3AE' }}>Supplier</th>
                  {COLUMNS.map(col => (
              ...
              <tbody>
                {filtered.map(d => (
                  <tr key={d.supplier} style={{ borderBottom: '1px solid #F5F5F9' }} className="hover:bg-gray-50">
