  ...
  return (
    <AppShell {...ACCOUNTING_CONFIG} navItems={ACCOUNTING_NAV} activeHref="/accounting/settings">
      <div className="p-6 space-y-6 max-w-2xl mx-auto">
        <div><h1 className="text-xl font-bold" style={{ color: '#433C50' }}>Pengaturan Akuntansi</h1><p className="text-sm mt-0.5" style={{ color: '#A5A3AE' }}>Konfigurasi modul akuntansi</p></div>
