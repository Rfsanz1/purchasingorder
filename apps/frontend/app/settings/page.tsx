      ...
      {fields.map((f) => (
        <div key={f.key}>
          ...
          <input
            ...
            style={{ border: '1.5px solid #EDE8F5', color: '#433C50', outline: 'none', backgroundColor: '#FAFAFA' }}
      ...
      <div className="p-6 space-y-6 max-w-4xl mx-auto">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm mt-0.5" style={{ color: '#A5A3AE' }}>Konfigurasi perusahaan, integrasi, dan sistem ERP</p>
          </div>
          <div className="flex gap-2">
            <button onClick={load} className="p-2.5 rounded-lg transition" style={{ border: '1px solid #EDE8F5', color: '#A5A3AE' }}>
        ...
        <div className="bg-white rounded-2xl p-6" style={{ border: '1.5px solid #EDE8F5', boxShadow: '0 1px 4px rgba(47,43,61,.06)' }}>
          {loading ? (
            <div className="space-y-4">
              {[1,2,3,4].map(i => <div key={i} className="h-12 rounded-lg animate-pulse" style={{ backgroundColor: '#F5F5F9' }} />)}
            </div>
          ) : (
            <>
              {tab === 'company' && (
                <div>
                  <h3 className="font-semibold mb-4 flex items-center gap-2" style={{ color: '#433C50' }}>
              ...
              {tab === 'document' && (
                <div>
                  <h3 className="font-semibold mb-2 flex items-center gap-2" style={{ color: '#433C50' }}>
                    <Hash className="h-4 w-4" style={{ color: C }} /> Format Nomor Dokumen
                  </h3>
                  <p className="text-xs mb-4" style={{ color: '#A5A3AE' }}>Nomor dokumen otomatis akan menggunakan format: PREFIX-YYYY-NNNNN</p>
              ...
              {tab === 'email' && (
                <div>
                  ...
                  <div className="mt-6 p-4 rounded-xl" style={{ backgroundColor: 'rgba(84,110,122,.08)', border: '1px solid rgba(84,110,122,.2)' }}>
                    ...
                    <p className="text-xs" style={{ color: '#6D6777' }}>Untuk Gmail: gunakan App Password, bukan password biasa. Aktifkan 2FA terlebih dahulu di akun Google Anda, lalu buat App Password di myaccount.google.com.</p>
                  </div>
                </div>
              )}
              {tab === 'wa' && (
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="p-4 rounded-xl flex items-center justify-between" style={{ backgroundColor: 'rgba(84,110,122,.06)', border: '1.5px solid #EDE8F5' }}>
                      <div>
                        <p className="text-sm font-semibold" style={{ color: '#433C50' }}>Backup Database</p>
                        <p className="text-xs mt-0.5" style={{ color: '#A5A3AE' }}>Download file backup database lengkap</p>
                      </div>
                    ...
                    <div className="p-4 rounded-xl flex items-center justify-between" style={{ backgroundColor: 'rgba(84,110,122,.06)', border: '1.5px solid #EDE8F5' }}>
                      <div>
                        <p className="text-sm font-semibold" style={{ color: '#433C50' }}>Jadwal Backup Otomatis</p>
                        <p className="text-xs mt-0.5" style={{ color: '#A5A3AE' }}>Backup otomatis setiap hari pukul 00:00</p>
                      </div>
                    ...
                    <div className="p-4 rounded-xl" style={{ backgroundColor: 'rgba(234,84,85,.06)', border: '1.5px solid rgba(234,84,85,.2)' }}>
                      ...
                      <p className="text-xs mb-3" style={{ color: '#6D6777' }}>Peringatan: Restore akan menggantikan semua data yang ada. Pastikan Anda memiliki backup terbaru sebelum melanjutkan.</p>
              ...
              {tab === 'api' && (
                <div>
                  ...
                  <div className="mt-6">
                    <h4 className="text-sm font-semibold mb-3" style={{ color: '#433C50' }}>API Key Sistem</h4>
                    <div className="p-4 rounded-xl flex items-center justify-between" style={{ backgroundColor: '#F8F7FC', border: '1.5px solid #EDE8F5' }}>
                      <div>
                        <p className="text-xs font-medium" style={{ color: '#A5A3AE' }}>API Key</p>
                        <p className="text-sm font-mono mt-1" style={{ color: '#433C50' }}>gm_••••••••••••••••••••••••••••••••</p>
                      </div>
