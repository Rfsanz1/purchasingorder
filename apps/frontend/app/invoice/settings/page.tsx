  ...
  return (
    <AppShell {...INVOICE_CONFIG} navItems={INVOICE_NAV} activeHref="/invoice/settings">
      <div className="p-6 space-y-6 max-w-2xl mx-auto">
        <div><h1 className="text-xl font-bold" style={{ color: '#433C50' }}>Pengaturan Invoice</h1><p className="text-sm mt-0.5" style={{ color: '#A5A3AE' }}>Format dan konfigurasi invoice</p></div>
