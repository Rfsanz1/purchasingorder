    ...
    <AppShell {...DELIVERY_CONFIG} navItems={DELIVERY_NAV} activeHref="/delivery/areas">
      <div className="p-6 space-y-6 max-w-4xl mx-auto">
        <div className="flex items-center justify-between">
          <div><h1 className="text-xl font-bold" style={{ color: '#433C50' }}>Wilayah Pengiriman</h1><p className="text-sm mt-0.5" style={{ color: '#A5A3AE' }}>Kelola zona dan jadwal pengiriman</p></div>
        ...
        <div className="bg-white rounded-2xl" style={{ border: '1.5px solid #EDE8F5', boxShadow: '0 1px 4px rgba(47,43,61,.06)' }}>
          {loading ? <p className="p-6 text-sm" style={{ color: '#A5A3AE' }}>Memuat...</p>
          : areas.length === 0 ? <p className="p-6 text-sm" style={{ color: '#A5A3AE' }}>Belum ada wilayah terdaftar</p>
            ...
            <div key={a.id} className="flex items-center justify-between px-6 py-4"
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs mt-0.5" style={{ color: '#A5A3AE' }}>Driver: {a.driver || '–'} · Jadwal: {a.jadwal || '–'}</p>
                </div>
              </div>
            </div>
          ))}
