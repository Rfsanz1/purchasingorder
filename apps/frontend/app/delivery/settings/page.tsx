  ...
  return (
    <AppShell {...DELIVERY_CONFIG} navItems={DELIVERY_NAV} activeHref="/delivery/settings">
      <div className="p-6 space-y-6 max-w-2xl mx-auto">
        <div><h1 className="text-xl font-bold" style={{ color: '#433C50' }}>Pengaturan Pengiriman</h1><p className="text-sm mt-0.5" style={{ color: '#A5A3AE' }}>Konfigurasi zona dan kebijakan pengiriman</p></div>
