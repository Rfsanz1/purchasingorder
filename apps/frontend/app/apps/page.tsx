...
const APP_DEFS: ERPApp[] = [
  ...
  { id: 'payroll', name: 'Penggajian', desc: 'Gaji, tunjangan & slip gaji', longDesc: 'Hitung gaji otomatis dengan aturan gaji yang fleksibel, tunjangan, potongan, dan integrasi BPJS serta pajak PPh 21.', icon: DollarSign, color: '#673AB7', bgColor: '#EDE7F6', category: 'SDM', version: '17.0', installs: '6.2K', rating: 4.6, deps: ['hr'], href: '/payroll' },
  { id: 'attendance', name: 'Kehadiran', desc: 'Absensi & jam kerja', longDesc: 'Lacak kehadiran karyawan dengan integrasi mesin fingerprint, aplikasi mobile, dan pelaporan lembur otomatis.', icon: Clock, color: '#009688', bgColor: '#E0F2F1', category: 'SDM', version: '17.0', installs: '5.8K', rating: 4.5, deps: ['hr'], href: '/hr/attendances' },
  { id: 'leave', name: 'Cuti & Izin', desc: 'Manajemen cuti karyawan', longDesc: 'Kelola pengajuan cuti, persetujuan atasan, saldo cuti, dan jenis cuti sesuai kebijakan perusahaan.', icon: BookOpen, color: '#FF7043', bgColor: '#FBE9E7', category: 'SDM', version: '17.0', installs: '4.9K', rating: 4.4, deps: ['hr', 'attendance'], href: '/hr/leaves' },
  ...
  { id: 'quality', name: 'Kontrol Kualitas', desc: 'QC, inspeksi & alert kualitas', longDesc: 'Buat quality control points, jadwalkan inspeksi, dan pantau alert kualitas untuk memastikan standar produk terpenuhi.', icon: Award, color: '#1976D2', bgColor: '#E3F2FD', category: 'Produksi', version: '17.0', installs: '2.8K', rating: 4.4, deps: ['manufacturing'], href: '/quality' },
  { id: 'maintenance', name: 'Pemeliharaan', desc: 'Perawatan mesin & aset', longDesc: 'Jadwalkan maintenance preventif, kelola work order perbaikan, dan pantau riwayat perawatan semua aset dan mesin.', icon: Wrench, color: '#F57F17', bgColor: '#FFFDE7', category: 'Produksi', version: '17.0', installs: '2.3K', rating: 4.3, deps: ['manufacturing'], href: '/maintenance' },
  ...
  { id: 'project', name: 'Proyek', desc: 'Tugas, milestone & Kanban', longDesc: 'Kelola proyek dengan tampilan Kanban, Gantt, dan list. Lacak kemajuan, deadline, dan beban kerja tim secara real-time.', icon: Layers, color: '#5C6BC0', bgColor: '#E8EAF6', category: 'Layanan', version: '17.0', installs: '5.1K', rating: 4.7, deps: [], href: '/project' },
  ...
  { id: 'ecommerce', name: 'E-Commerce', desc: 'Toko online & katalog produk', longDesc: 'Buat toko online terintegrasi dengan inventaris dan pembayaran. Kelola produk, harga, dan order dari satu dashboard.', icon: Globe, color: '#00897B', bgColor: '#E0F2F1', category: 'Penjualan', version: '17.0', installs: '4.5K', rating: 4.5, deps: ['inventory', 'sales'], href: '/ecommerce' },
