  ...
  return (
    <AppShell {...PURCHASING_CONFIG} navItems={PURCHASING_NAV} activeHref="/purchasing/settings">
      <div className="p-6 space-y-6 max-w-2xl mx-auto">
        <div><h1 className="text-xl font-bold" style={{ color: '#433C50' }}>Pengaturan Pembelian</h1><p className="text-sm mt-0.5" style={{ color: '#A5A3AE' }}>Konfigurasi modul pengadaan</p></div>
