  ...
  return (
    <AppShell {...SALES_CONFIG} navItems={SALES_NAV} activeHref="/sales/settings">
      <div className="p-6 space-y-6 max-w-2xl mx-auto">
        <div>
          <h1 className="text-xl font-bold" style={{ color: '#433C50' }}>Pengaturan Penjualan</h1>
          <p className="text-sm mt-0.5" style={{ color: '#A5A3AE' }}>Konfigurasi modul penjualan</p>
        </div>
        <div className="bg-white rounded-2xl p-6 space-y-5" style={{ border: '1.5px solid #EDE8F5', boxShadow: '0 1px 4px rgba(47,43,61,.06)' }}>
          {[
            ...
            <div key={f.label}>
              ...
              <input className="w-full rounded-lg px-4 py-2.5 text-sm" style={{ border: '1.5px solid #EDE8F5', color: '#433C50', outline: 'none' }} placeholder={f.placeholder} defaultValue={f.defaultVal} />
            </div>
          ))}
