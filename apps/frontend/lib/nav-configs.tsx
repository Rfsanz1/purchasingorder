...
export const ACCOUNTING_NAV: NavItem[] = [
  ...
  { label: 'Rekonsiliasi Bank',  href: '/finance/bank-reconciliation', icon: Scale },
  { label: 'Aset Tetap',         href: '/finance/fixed-assets',        icon: Building2 },
  { label: 'Budget',             href: '/finance/budget',              icon: Target },
  { label: 'Multi Mata Uang',    href: '/finance/currencies',          icon: Globe },
  ...
  { label: 'Laporan',            href: '/finance/reports',             icon: TrendingUp,
    children: [
      { label: 'Laba & Rugi',    href: '/finance/reports?type=pl' },
      { label: 'Neraca',         href: '/finance/reports?type=bs' },
      { label: 'Cash Flow',      href: '/finance/reports?type=cf' },
      { label: 'Trial Balance',  href: '/finance/reports?type=tb' },
      { label: 'Buku Besar',     href: '/finance/reports?type=gl' },
    ],
  },
