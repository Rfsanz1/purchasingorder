...
export declare class FleetService {
    ...
    getMyDeliveryTasks(currentUser: any): Promise<any>;
    ...
    updateDeliveryStatus(id: string, dto: any, currentUser: any): Promise<{
        success: boolean;
        id: string;
        status: any;
    }>;
    getDeliveryHistory(query: any, currentUser: any): Promise<any>;
