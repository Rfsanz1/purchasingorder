...
export declare class HrService {
    ...
    getAttendances(query: any): Promise<{
        data: ({
            employee: {
                status: string;
                id: string;
    ...
    getContracts(query: any): Promise<{
        data: ({
            employee: {
                id: string;
                name: string;
    ...
    importAttendanceCsv(rows: any[]): Promise<{
        data: any[];
        message: string;
    }>;
    getAttendanceReport(employeeId: string, month: number, year: number): Promise<{
        employee: {
            status: string;
            id: string;
            email: string | null;
    ...
    getAttendanceSummary(month: number, year: number, departemenId?: string): Promise<{
        month: number;
        year: number;
        summary: {
            employeeId: string;
    ...
    assignShift(employeeId: string, shiftId: string): Promise<{
        message: string;
        employee: {
            id: string;
            name: string;
    ...
    getLeaveRequests(employeeId?: string, status?: string): Promise<{
        data: ({
            employee: {
                status: string;
                id: string;
    ...
    approveLeaveRequest(id: string, approvedBy: string): Promise<{
        data: {
            employee: {
                status: string;
                id: string;
    ...
    rejectLeaveRequest(id: string, rejectionReason?: string): Promise<{
        data: {
            employee: {
                status: string;
                id: string;
    ...
    getLeaveAllocations(employeeId?: string, year?: number): Promise<{
        data: ({
            employee: {
                status: string;
                id: string;
    ...
    getLeaveCalendar(month: number, year: number, departemenId?: string): Promise<{
        month: number;
        year: number;
        leaves: ({
            employee: {
