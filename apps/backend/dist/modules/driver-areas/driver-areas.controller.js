...
let DriverAreasController = class DriverAreasController {
    svc;
    constructor(svc) {
        this.svc = svc;
    }
...
], DriverAreasController.prototype, "findAll", null);
__decorate([
    Put(),
    __param(0, Body()),
    __metadata("design:type", Function),
    ...
    __metadata("design:returntype", void 0)
], DriverAreasController.prototype, "update", null);
DriverAreasController = __decorate([
    Controller('driver-areas'),
    UseGuards(JwtAuthGuard, CanAccessGuard),
    CanAccess({ roles: ['Super Admin', 'Owner', 'Admin', 'Driver'] }),
    __param(0, Inject(DriverAreasService)),
    __metadata("design:paramtypes", [DriverAreasService])
], DriverAreasController);
export { DriverAreasController };
