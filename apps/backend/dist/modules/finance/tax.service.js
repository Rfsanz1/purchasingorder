...
let TaxService = class TaxService {
    ...
    async getTaxSummary(query) {
        ...
        for (const line of lines) {
            ...
            summary[key].count += 1;
            if (line.tipe === 'COLLECTED')
                totalCollected += Number(line.taxAmount);
            if (line.tipe === 'PAID')
                totalPaid += Number(line.taxAmount);
        }
        return {
