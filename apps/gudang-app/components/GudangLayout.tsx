...
const NAV = [
  ...
  { href: '/picking',      label: 'Picking Order', icon: ClipboardList },
  { href: '/inbound',      label: 'Barang Masuk',  icon: ArrowDownRight },
  { href: '/outbound',     label: 'Barang Keluar', icon: ArrowUpRight },
  { href: '/transfer',     label: 'Transfer Stok', icon: ArrowLeftRight },
  { href: '/stock-opname', label: 'Stock Opname',  icon: ClipboardCheck },
  { href: '/products',     label: 'Cek Stok',      icon: Search },
        ...
        <header style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
            ...
            <div>
              ...
              {!title && <span style={{ fontSize: 15, fontWeight: 700, color: C.primary }}>Gudang App</span>}
            </div>
          </div>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '18px 16px', borderBottom: '1px solid rgba(255,255,255,.15)' }}>
        ...
        <div style={{ flex: 1 }}>
          <p style={{ fontSize: 14, fontWeight: 700, color: '#fff', margin: 0 }}>Gudang App</p>
